...
export default function LembretesListaScreen({ navigation, route }) {
  ...
  // Filtra só os lembretes que pertencem a essa lista
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerTextos}>
          ...
          <Text style={styles.subtitulo}>{lembretesLista.length} lembrete(s)</Text>
        </View>
      </View>
      ...
      <FlatList
            ...
            <View style={styles.cardTopo}>
              <View style={{ flex: 1 }}>
                <View style={styles.tituloLinha}>
                  {item.prioridade && (
                  <View style={{ backgroundColor: corPrioridade[item.prioridade] + '20', borderRadius: 4, paddingHorizontal: 6, paddingVertical: 2, borderWidth: 1, borderColor: corPrioridade[item.prioridade] }}>
                  ...
                  <Text style={[styles.cardTitulo, item.concluido && styles.cardTituloConcluido]}>
                    {item.titulo}
                  </Text>
                </View>
              ...
              <View style={styles.acoes}>
                <TouchableOpacity
                  style={[styles.btnCheck, item.concluido && styles.btnCheckAtivo]}
        ...
        ListEmptyComponent={
          <Text style={styles.vazio}>Nenhum lembrete nessa lista ainda.</Text>
        }
      />

      {/* Botão flutuante com a cor da lista */}
      <TouchableOpacity
        style={styles.fab}
        onPress={() => navigation.navigate('CriarLembrete', { listaId: lista.id })}
      >
